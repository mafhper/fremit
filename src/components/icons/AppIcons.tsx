...
export function GitHubPanelIcon({ className }: IconProps) {
  return (
    <IconFrame className={className}>
      <path
        d="M12 4.2a7.8 7.8 0 0 0-2.47 15.2c.38.07.52-.16.52-.37v-1.32c-2.11.46-2.56-.9-2.56-.9-.35-.88-.84-1.11-.84-1.11-.69-.47.05-.46.05-.46.76.05 1.16.78 1.16.78.67 1.16 1.77.82 2.2.63.07-.49.26-.82.47-1.01-1.68-.19-3.45-.84-3.45-3.73 0-.82.29-1.49.77-2.02-.08-.19-.34-.96.07-2 .01 0 .63-.2 2.06.77a7.1 7.1 0 0 1 3.76 0c1.43-.97 2.06-.77 2.06-.77.41 1.04.15 1.81.08 2 .48.53.77 1.2.77 2.02 0 2.9-1.78 3.53-3.47 3.72.27.24.52.7.52 1.41v2.09c0 .21.14.44.52.36A7.8 7.8 0 0 0 12 4.2Z"
        fill="currentColor"
        opacity="0.16"
      />
      <path
